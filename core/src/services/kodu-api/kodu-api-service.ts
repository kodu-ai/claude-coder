...
export class KoduApiService {
	private api: KoduApiClient
	private customInstructions?: string
	// private providerRef: WeakRef<ExtensionProvider> //TODO: refactor

	constructor(configuration: ApiClientConfiguration, customInstructions?: string) {
		this.api = new KoduApiClient({ koduApiKey: configuration.koduApiKey, apiModelId: configuration.apiModelId })
		this.customInstructions = customInstructions
		// this.providerRef = new WeakRef(provider) //TODO: refactor
	}

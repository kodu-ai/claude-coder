...
const ChatRow: React.FC<ChatRowProps> = ({
					...
					case "api_req_started":
						return (
							<>
								...
								{apiRequestFailedMessage && <div className="text-error">{apiRequestFailedMessage}</div>}
							</>
						)
	...
	// we automatically transform api_req_started to error message so we don't need to actually display the api_req_failed row
	if (message.ask === "api_req_failed") return null

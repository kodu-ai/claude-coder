...
/*
MIT Saoud Rizwan:
https://github.com/saoudrizwan/claude-dev/blob/3a850b029934b3844edffd32e60cc7d3f97b5d99/src/integrations/TerminalManager.ts
TerminalManager:
...
class TerminalRegistry {
	...
	static createTerminal(cwd?: string | vscode.Uri | undefined): TerminalInfo {
		const terminal = vscode.window.createTerminal({
			...
			// 	vscode.extensions.getExtension("kodu.claude-coder")!.extensionUri,
			// 	"assets/icon.png"
			// ),
		})

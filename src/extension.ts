...
export function activate(context: vscode.ExtensionContext) {
	...
	// const disposable = vscode.commands.registerCommand("kodu-claude-coder-upstream.helloWorld", () => {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("kodu-claude-coder-upstream.popoutButtonTapped", openClaudeDevInNewTab)
	)
	context.subscriptions.push(
		vscode.commands.registerCommand("kodu-claude-coder-upstream.openInNewTab", openClaudeDevInNewTab)
	)

  ...
  return (
    <>
      <h3 className="text-alt items-center flex gap-1.5">
        {lastMessage.text === message.text ? <Loader2 className="animate-spin size-4" /> : toolIcon("device-camera")}
        {message.type === "ask" ? <>Claude wants to take a screenshot of the url</> : <>Claude took a screenshot of the url</>}
      </h3>

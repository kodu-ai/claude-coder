...
import { CollapseButton, File, Folder, Tree, type TreeViewElement } from './tree-view-api'
...
export const TreeView = ({
	...
	return (
		<div ref={containerRef} className={cn('w-full rounded-md overflow-hidden py-1 relative', className)}>
			<Tree

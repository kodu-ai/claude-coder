...
export type AmplitudeWebviewMessage = {
    type: "amplitude";
    event_type: "AuthStart" | "ReferralProgram" | "ExtensionCreditAddOpen" | "TrialOfferView" | "TrialOfferStart" | "TrialUpsellView" | "TrialUpsellStart" | "ExtensionCreditAddSelect" | "OfferwallView";
    key?: string;
};
type RenameTask = {
    type: "renameTask";
...
export type PromptActions = PreviewPromptMessage | DisableToolMessage | OpenPromptEditorMessage | listPromptTemplatesMessage | savePromptTemplateMessage | loadPromptTemplateMessage | setActivePromptMessage | deletePromptTemplateMessage | ClosePromptEditorMessage;
...
export type WebviewMessage = EnableObserverHookMessage | PromptActions | ActionMessage | clearHistoryMessage | rollbackToCheckpointMessage | viewFileMessage | setCommandTimeoutMessage | toggleGitHandlerMessage | setInlineEditModeMessage | pauseTemporayAutoModeMessage | terminalCompressionThresholdMessage | setApiKeyDialogMessage | pauseNextMessage | autoSummarizeMessage | updateGlobalStateMessage | AmplitudeWebviewMessage | OpenExternalLink | autoCloseTerminalMessage | RenameTask | DebugMessage | customInstructionsMessage | {
    type: "skipWriteAnimation" | "cancelCurrentRequest" | "maxRequestsPerTask" | "alwaysAllowReadOnly" | "webviewDidLaunch" | "newTask" | "askResponse" | "retryTask" | "alwaysAllowWriteOnly" | "clearTask" | "didCloseAnnouncement" | "selectImages" | "exportCurrentTask" | "showTaskWithId" | "deleteTaskWithId" | "exportTaskWithId" | "promptEditorLoaded" | "didClickKoduSignOut" | "fetchKoduCredits" | "resetState" | "fileTree";
    text?: string;

...
export type ToolParams = AddInterestedFileToolParams | AskFollowupQuestionToolParams | AttemptCompletionToolParams | ServerRunnerToolParams | ExecuteCommandToolParams | ExploreRepoFolderToolParams | ListFilesToolParams | ReadFileToolParams | SearchFilesToolParams | SearchSymbolsToolParams | UrlScreenshotToolParams | WebSearchToolParams | FileChangePlanParams | RejectFileChangesParams | WriteToFileToolParams | EditFileBlocksToolParams | FileEditorToolParams | SpawnAgentToolParams | ExitAgentToolParams | SubmitReviewToolParams;

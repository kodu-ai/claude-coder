tools = [
    ...
    {
        "name": "web_search",
        "description": "Let's you ask a question about links and generate a short summary of information regarding a question, you can provide a link to access directly or a search query, at both stages you are required to provide a general question about this web search.",
        "input_schema": {
            "type": "object",
            "properties": {
                "searchQuery": {
                ...
                "baseLink": {
                    "type": "string",
                    "description": "The base link provided by the user. If it is provided, you can start your search from here.",
                },
            },
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "url": {"type": "string", "description": "The url provided by the user"}
            },
            "required": ["searchQuery"],
        },
    },
